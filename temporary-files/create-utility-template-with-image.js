...
async function createUtilityTemplate() {
    console.log('🚀 CREATING UTILITY TEMPLATE WITH IMAGE HEADER');
    ...
    console.log('\n🎯 Why UTILITY?');
    console.log('   ✅ Bypasses 24-hour conversation window');
    console.log('   ✅ Not subject to marketing limits');
    console.log('   ✅ Can reach cold subscribers');
    console.log('   ✅ Considered transactional/service message\n');
    ...
    try {
        ...
        console.log('\n📁 Template info saved to: utility-template-info.json');
        console.log('\n⏳ Next Steps:');
        ...
        console.log('\n🎯 This UTILITY template should deliver even to cold subscribers!');
        
        return templateInfo;
        
    } catch (error) {
        console.error('\n❌ Failed to create UTILITY template:', error.response?.data || error.message);
...
async function createReplyTemplate() {
    console.log('\n' + '=' .repeat(60));
    console.log('📝 BONUS: Creating Reply-to-Open-Window Template');
    console.log('=' .repeat(60) + '\n');
    ...
    console.log('📱 Strategy: Reply-to-Open-Window');
    ...
    try {
        ...
        console.log('✅ Reply template created!');
        console.log(`   Name: ${templateName}`);
        console.log(`   Status: ${response.data.status || 'PENDING'}`);
        ...
        console.error('❌ Failed to create reply template:', error.response?.data?.error?.message || error.message);
        return null;
    }
}
...
async function main() {
    ...
    if (utilityTemplate) {
        console.log('\n✅ UTILITY template with IMAGE created');
        console.log('   This should bypass marketing limits!');
    }
    
    if (replyTemplate) {
        console.log('\n✅ Reply-to-open template created');
    ...
    console.log('\n📱 CHECK WHATSAPP after approval and sending.');
}
