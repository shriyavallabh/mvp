...
class WhatsAppImageTemplateCreator {
    ...
    async uploadImageAndGetHandle(imageUrl) {
        console.log('📤 Uploading image to Meta servers...');
        ...
        try {
            ...
            if (sessionResponse.data.id) {
                console.log(`   ✅ Upload session created: ${sessionResponse.data.id}`);
    ...
    async createTemplateWithDirectUrl() {
        console.log('\n📝 Creating template with direct image URL...\n');
        ...
        const template = {
            ...
            components: [
                ...
                },
                {
                    ...
                    example: {
                        body_text: [
                            ['Shruti', 'Portfolio Update', 'March 2024', '₹45,00,000', '+18.5%']
                        ]
                    }
                },
                {
    ...
    async createSimpleImageTemplate() {
        console.log('\n📝 Creating simple image template...\n');
        ...
        const template = {
            ...
            components: [
                ...
                },
                {
                    ...
                    example: {
                        body_text: [
                            ['Shruti', '₹45,00,000', 'Tap to view details']
                        ]
                    }
                }
            ]
    ...
    async createTemplateWithMediaHandle() {
        console.log('\n📝 Creating template with media handle...\n');
        ...
        const template = {
            ...
            components: [
                ...
                },
                {
                    ...
                    example: {
                        body_text: [
                            ['Investor', 'Monthly Performance Report', '₹45,00,000', '₹50,00,000']
                        ]
                    }
                }
            ]
    ...
    async createImageTemplates() {
        ...
        results.forEach(result => {
            if (result.success) {
                console.log(`✅ ${result.method}: Template "${result.name}" created`);
        ...
        if (successful > 0) {
            ...
            console.log('\n⚠️ All template creation methods failed');
    ...
    async testImageTemplate(templateName) {
        ...
        try {
            ...
            console.log(`   ✅ Message sent with image template!`);
...
async function main() {
    ...
    try {
        ...
        if (successfulTemplate) {
            console.log('\n🧪 TESTING IMAGE TEMPLATE DELIVERY');
            console.log('===================================');
